...
//! on the same wire schema for session snapshots, prompt submission, named SSE
//! events, and browser auth/account management.

use acp_contracts::{
    AccountListResponse, AuthStatusResponse, BootstrapRegistrationRequest,
    BootstrapRegistrationResponse, CancelTurnResponse, CreateAccountRequest, CreateAccountResponse,
    CreateSessionResponse, DeleteAccountResponse, DeleteSessionResponse, ErrorResponse,
    LocalAccount, PermissionDecision, PromptRequest, RenameSessionRequest, RenameSessionResponse,
    ResolvePermissionRequest, SessionListItem, SessionListResponse, SessionResponse,
    SessionSnapshot, SignInRequest, SignInResponse, StreamEvent, UpdateAccountRequest,
