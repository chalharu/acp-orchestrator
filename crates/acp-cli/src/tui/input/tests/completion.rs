...
#[test]
fn handle_key_covers_completion_shortcuts() {
...
#[tokio::test]
async fn update_completion_menu_records_timeouts_and_keeps_multiple_matches() {
...
#[tokio::test]
async fn apply_command_outcome_updates_status_catalog_and_permissions() {
